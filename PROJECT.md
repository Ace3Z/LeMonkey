...
- [`P1-VLA.docx`](P1-VLA.docx) — official project brief (authoritative source)
- [`Robot_Learning_FS26_Brev_Instruction.pdf`](Robot_Learning_FS26_Brev_Instruction.pdf) — Brev setup instructions (original PDF)
