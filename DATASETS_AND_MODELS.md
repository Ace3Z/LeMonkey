...
| [`HBOrtiz/so101_smolvla_eval3_broad`](https://huggingface.co/HBOrtiz/so101_smolvla_eval3_broad) | broad and out-of-distribution | SmolVLA-450M co-trained on the 192-celebrity robot dataset plus the 192-celebrity vision-language grounding pairs. Trained for 30k steps; the step_025000 checkpoint is deployed at the repo root, intermediates under `checkpoints/`. |
