...
| Augmented + base merged dataset | [`HBOrtiz/so101_eval3_broad`](https://huggingface.co/datasets/HBOrtiz/so101_eval3_broad) (public) | 4195 episodes, 933 unique prompts, 2.26M frames, 7.5 GB. Schema: `observation.images.camera1` (480×640 wrist) + `observation.images.reference` (480×480 constant-frame ref photo). |
