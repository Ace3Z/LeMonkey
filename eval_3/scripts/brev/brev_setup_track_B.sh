#!/usr/bin/env bash
# Brev-side env setup for Track B (Pi0.5 + LoRA).
#
# Differs from eval_1/scripts/brev_setup.sh: that script installed
# `lerobot[smolvla]==0.5.1` from PyPI; Track B needs Pi0.5 + PEFT support
...
echo "    cd ~/LeMonkey && bash eval_3/scripts/brev/run_training_track_B.sh"
