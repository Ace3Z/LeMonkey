...
# 192-celebrity dataset (so101_eval3_all), 30k steps. Final 25k checkpoint at
...
#   ./run_rollout_smolvla_eval3.sh                      # default = root (final 25k)
#   ./run_rollout_smolvla_eval3.sh checkpoints/020000   # an earlier checkpoint
...
while true; do
  ...
  RUN_NAME="smolvla_eval3_${i}_${TS}"
