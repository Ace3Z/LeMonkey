#!/usr/bin/env bash
# Run the full Track 2 data-side pipeline when Roham's bboxes arrive.
#
...
WORK_DIR="${WORK_DIR:-$HOME/.cache/track2_audit}"
mkdir -p "$WORK_DIR"
...
python3 eval_3/scripts/track_2/build_keep_list_and_weights.py \
...
echo "    - $AUDIT_PARQUET"
echo "    - eval_3/scripts/track_2/keep_episodes.txt"
echo "    - eval_3/scripts/track_2/hardneg_weights.npy"
echo "    - eval_3/scripts/track_2/build_keep_list_summary.json"
echo
echo "==> Next: launch Track 2 smoke test on brev_instance2:"
echo "    STEPS=200 bash eval_3/scripts/brev/run_training_track_2.sh"
