#!/usr/bin/env python3
"""Build the cotrain (3-IID-celeb) photo bank: 8 photos per IID celeb.
...
Output layout (per the cotrain spec: 8 photos/celeb):
    datasets/eval3_celebs/cotrain_bank/<full>/
